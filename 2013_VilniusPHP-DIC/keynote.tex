...
\begin{phpcode}
    ...
    $container['feed.somefeed.interval'] = '* */6 * * * *';
...
\begin{phpcode}
    ...
    //Change value
    $container['feeds']['feed.somefeed.interval'] = '* */12 * * * *';
